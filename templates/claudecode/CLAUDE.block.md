...
Claude Code already matches upstream superpowers semantics closely. Prefer the native Skill system and native task delegation instead of rewriting those workflows into ad-hoc prompts.
