...
When a superpowers skill recommends parallel or delegated execution, split work only across isolated surfaces and keep final integration plus validation in the main thread.
