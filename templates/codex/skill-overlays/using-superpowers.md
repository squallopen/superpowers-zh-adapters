...
- When a skill references Claude Code's Task tool or `general-purpose` subagents, map that to Codex subagents and the instructions in `using-superpowers/references/codex-tools.md`.
